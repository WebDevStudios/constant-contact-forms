...
class ConstantContact_Builder {
	...
	/**
 	 ...
 	 * @var string
 	 */
	private $key = 'ctct_options_builder';

	/**
 	 * Settings page metabox id
 	 * @var string
 	 */
	private $metabox_id = 'ctct_option_metabox_builder';
	...
	public function add_options_page() {
        ...
        $this->options_page = add_submenu_page(
            ...
            __( 'Form Builder', constant_contact()->text_domain ),
            __( 'Form Builder', constant_contact()->text_domain ),
            'manage_options',
            $this->key,
	...
	public function admin_page_display() {
		...
		<div class="wrap cmb2-options-page <?php echo $this->key; ?>">
			<h2><?php esc_attr_e( constant_contact()->plugin_name . ' Form Builder', constant_contact()->text_domain ); ?></h2>
 ...
 */
function ctct_get_builder_option( $key = '' ) {
