					...
					<div class="ctct-modal-content">
						...
						<div class="ctct-modal-body">
							...
							<div class="ctct-modal-right">
								...
								<a href="<?php echo esc_url_raw( add_query_arg( [ 'rmc' => 'wp_fmodal_connect' ], constant_contact()->api->get_authorization_url() ) ); ?>" target="_blank" rel="noopener noreferrer" class="button button-blue connection-settings-redirect" title="<?php esc_attr_e( 'Connect Plugin', 'constant-contact-forms' ); ?>">
