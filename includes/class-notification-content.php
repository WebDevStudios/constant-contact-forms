...
class ConstantContact_Notification_Content {
	...
	public static function review_request() {
		...
		<div class="admin-notice-message">
			<div>
				<?php _e( 'You have been successfully using <strong>Constant Contact Forms</strong>. Congratulations on successfully capturing valuable site visitor information! Please consider leaving us a nice review. Reviews help fellow WordPress admins find our plugin and lets you provide us useful feedback.', 'constant-contact-forms' ); ?>
